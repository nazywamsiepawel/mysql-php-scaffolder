...
#functions
f:user(create, read, update, delete, gets);
f:network(create, read, update, delete, gets);
f:business(create, read, update, delete, gets);
f:event(create, read, update, delete, gets);
f:update(create, read, update, delete, gets);
